export function Contact() {
  return (
    <section id="contact" className="border-t border-neutral-900 px-6 py-28 md:px-10 md:py-40">
      <div className="mx-auto max-w-6xl">
        <p className="text-[13px] tracking-[0.15em] text-neutral-500">Get in touch</p>
        <a
          href="mailto:smack.valentin@gmail.com"
          className="mt-8 block font-serif text-4xl italic leading-tight text-neutral-50 transition-colors hover:text-orange-500 md:text-7xl"
        >
