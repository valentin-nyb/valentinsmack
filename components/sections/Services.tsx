...
export function Services() {
  return (
    <section id="services" className="border-t border-neutral-900 px-6 py-28 md:px-10 md:py-36">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-12 grid gap-x-16 gap-y-14 md:grid-cols-2">
          {services.map((service, i) => (
            <div key={service.title} className="border-t border-neutral-900 pt-8">
              <span className="font-serif italic text-neutral-600">
                {String(i + 1).padStart(2, "0")}
              </span>
              <h3 className="mt-4 font-display text-2xl font-black text-neutral-100 md:text-3xl">
                {service.title}
              </h3>
